<?php  
    ...
    $query_assest   = " SELECT * from  TB_ASSEST  WHERE  STATUS in('1','2') "; 
                ...
                <section class="col-lg-12 connectedSortable">  
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">  โอนย้ายทรัพย์สิน  </h3>
                        </div> 
                        <div class="card-body"> 
                            <div class="row form-group">
                                <label class="col-sm-2"></label> 
                                <div class="col-sm-8">  
                                    <button type="button" name="add" id="add" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-warning"> เพิ่มรายการโอนย้ายทรัพย์สิน  </button>  
                                </div>  
                            </div> 
                            <div class="row" id="employee_table1"></div>
                            <hr/>
                            <div class="row form-group">
                                <div class="col-sm-1">สาขาต้นทาง </div> 
                                <div class="col-sm-2"> 
                                ...
                                <div class="col-sm-1">สาขาต้นปลายทาง</div> 
                                <div class="col-sm-2"> 
                                    <select class="form-control" style="width: 100%;" id="branch_stop" name="branch_stop">
                                        <option value=""> -- กรุณาเลือกสาขา -- </option> 
                                        <?php   foreach ($conn->query($query) as $bra) { ?>
                                            <option value="<?php echo $bra["BRCODE"]; ?>"> <?php echo $bra["BRCODE"] . " - " . $bra["FS_NAME"]; ?></option>
                                        <?php }  ?>
                                ...
                                <div class="col-sm-2"><input type="text"  id="location" name="location"  placeholder="สถานที" class="form-control rounded-0 form-control-border"> </div> 
    ...
    <div class="modal-dialog modal-lg">  
        <div class="modal-content">  
            <div class="modal-header">  
                <h4 class="modal-title"> โอนย้ายทรัพย์สิน </h4>  
            </div>  
                        ...
                        <div class="col-sm-12"> 
                            <select class="form-control select2" style="width: 100%;" id="ASSESTID" name="ASSESTID">
                                ...
                                <?php foreach ($conn_1->query($query_assest) as $assest) {?>
                                    <option value="<?php echo $assest["ASSESTID"]?>"><?php echo $assest["ASSEST_NUMBER"]." - ".$assest["ASSEST_NO"]. " - " .$assest["DETAIL"] ?></option>
                                <?php } ?>
                            </select>
                        </div> <br/>
...
<script>  
    ...
    $("#bt_send").click(function() {
        ...
        let branch_stop     = $('#branch_stop').val().trim();
