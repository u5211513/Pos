<?php  
    ...
    $query_B = " SELECT BANKID, BANKNAME   from TB_BANKOFSTATION   ORDER BY FSCODE ASC";  
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-2"> 
                                    <input type="text" class="form-control rounded-0" id="amount" name="amount"  placeholder="0.00"  onkeyup="dokeyupf(this);" onchange="dokeyupf(this);" onkeypress="checknumber()"  >
                                </div>
                                <label class="col-md-2 text-right"> จำนวนเงินที่ฝาก kerry    </label> 
                                <div class="col-md-3"> 
                                    <input type="text" class="form-control rounded-0" id="amount_kerry" name="amount_kerry"  placeholder="0.00"  onkeyup="dokeyupf(this);" onchange="dokeyupf(this);" onkeypress="checknumber()"  >
                                </div> 
                            </div>  
                            <div class="row form-group">
