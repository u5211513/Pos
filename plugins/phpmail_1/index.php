<?php
    ...
    $text_mess = "<p>    text   </p>";
    $text_mess .= "<p> 1111111 </p>";
    $text_mess .= "<p> 2222222 </p>";
    $text_mess .= "<p> 3333333 </p>"; 
    ...
    $mail->AddAttachment($ourFileName , $srcFile, 'base64', 'application/vnd.ms-excel');
    $mail->setFrom('IT_CENTER@fascino.co.th', 'FACINO'); 
    $mail->addAddress('programmer2@fashofgroup.com');

    //send an email 
    if ($mail->send())
        echo "mail is sent success!";
    else
        echo $mail->ErrorInfo;
